  ...
  return <main className="min-h-screen bg-[#f4efe6] text-[#171512]">
    <header className="sticky top-0 z-50 border-b-2 border-black bg-[#f4efe6]/95 backdrop-blur"><div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-10">
      ...
      <nav className="ml-auto hidden items-center gap-5 text-sm font-bold md:flex">
        ...
        <Link href="/booking" className="py-2">SNEAKER CLEANING</Link><a href="#about" className="py-2">ABOUT</a><Link href="/account" className="rounded-full border-2 border-black px-4 py-2 text-xs">MEMBER</Link>
      </nav>
      <div className="ml-8 shrink-0"><CartIndicator /></div>
    </div><nav className="grid grid-cols-5 border-t border-black/20 text-center text-[10px] font-black sm:text-xs md:hidden"><a href="#shop" className="border-r border-black/20 px-1 py-3">SHOP</a><Link href="/korean-snacks" className="border-r border-black/20 px-1 py-3">K-SNACK</Link><Link href="/booking" className="border-r border-black/20 px-1 py-3">CLEANING</Link><a href="#about" className="border-r border-black/20 px-1 py-3">ABOUT</a><Link href="/account" className="px-1 py-3">MEMBER</Link></nav></header>
